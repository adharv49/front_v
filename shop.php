                            ...
                            if (!isset($_GET['cat_id'])) {
                                ...
                                while ($row_products = mysqli_fetch_array($run_products)) {
                                    ...
                                    <div class='product-item'>
                                        <div class='pi-pic' style='max-height:350px; object-fit: contain;width:350px;height:350px;'>
                                            <img src='img/products/$product_img1' alt='$product_title' style='object-fit: contain;width:350px;height:350px;'>
                                            <ul>
